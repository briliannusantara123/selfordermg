...
<br>
<form action="<?= base_url() ?>cart/validasi_order/<?= $nomeja ?>/<?= $cek ?>/<?= $sub ?>#<?= $sub ?>" method="POST">
<div class="container" >
<?php if ($item == NULL): ?>
...
<button type="submit" class="btn btn-outline-success" style="padding-top: 20px;padding-bottom: 20px;padding-left: 50px;padding-right: 50px;" onclick="order()">
  Order
</button>
...
<div class="modal fade" id="exampleModal<?= $i->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="<?= base_url() ?>cart/ubah/<?= $i->id ?>/<?= $nomeja ?>/<?= $cek ?>/<?= $sub ?>" method="post">
