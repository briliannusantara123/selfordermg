...
<div id="loadingkonek"></div>
  ...
  <div class="container">
  <div class="row">
    <div class="col-12"><h3 style="padding-top: 14px;padding-bottom:13px;color: white;text-align: center">Lines List Order Selforder<a href="<?= base_url()?>daftarorder/history" class="btn btn-danger" style="float: right">Back</a></h3></div>
