...
if (localStorage.getItem('<?=$i->no?>')) {
  ...
  simpan<?= $i->id ?>.addEventListener("click", ()=>{
    ...
    if (window.location.toString() == "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks") {
      var h = '<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>orderminuman/menu/Minuman/Soft%20Drinks#Soft_Drinks";
    }else if (window.location.toString() == "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink") {
      var h = '<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink";
    }
  ...
  if (simpan<?= $i->id ?>) {
    ...
    if (window.location.toString() == "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks") {
      var h = '<?= base_url() ?>orderminuman/menu/Minuman/Soft%20Drinks#Soft_Drinks';
          // alert(h);
          $('#konten').load(h);
      window.location.href = "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Soft_Drinks";
    }else if (window.location.toString() == "<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink") {
      var h = '<?= base_url() ?>orderminuman/menu/Minuman/Cold%20Drink#Cold_Drink';
          // alert(h);
          $('#konten').load(h);
