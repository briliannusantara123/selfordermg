<?php $this->load->view('template/head') ?>
  ...
  <div class="row">
    ...
    <div class="col-2"><a style="text-align: center;margin-top: 6px;" href="<?php echo base_url() ?>Cart/home/<?= $no_meja ?>" class="btn btn-outline-succes"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" color="white" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
...
<div class="container ">
  <div class="row">
    <div class="col bg-success" style="margin-left:30px;border-bottom-left-radius: 20px;padding-top: 10px; ">
      ...
      <p style="color: white;">Table No : <?= $no_meja ?></p>
    </div>
...
<div class="container text-center">
  <div class="row" style="margin-top: 1px;">
    <div class="col">
      <a class="" href="<?= base_url() ?>ordermakanan/menu/Makanan/<?= $sub_category ?>/<?= $no_meja ?>" role="button"  style="text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-makanan.png" style="width: 125px;height: 125px;background-color: #198754;border-radius: 50%;" alt="Hachi Grill" /><p style="color:#198754;margin-top: 5px; ">Order Makanan</p></a>
      <a class="" href="<?= base_url() ?>ordersementara/home/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/lihat-order-sementara.png" style="width: 125px;height: 125px;margin-top: 5px;background-color: #198754;border-radius: 50%;" alt="Hachi Grill" /><p style="color:#198754;margin-top: 5px; ">Melihat Order <br>Sementara</p></a>
      <a class="" href="<?php echo base_url() ?>Kasir_waitress/memanggil/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/memanggil-waiter.png" style="width: 125px;height: 125px;margin-top: 5px;background-color: #198754;border-radius: 50%;" alt="Hachi Grill" /><p style="color:#198754;margin-top: 5px; ">Memanggil Waitress</p></a>
    </div>
 
    <div class="col">
      <a class="" href="<?= base_url() ?>orderminuman/menu/Minuman/<?= $sub_category_minuman ?>/<?= $no_meja ?>" role="button"  style="margin-top: 20px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-minuman.png" style="width: 125px;height: 125px;background-color: #198754;border-radius: 50%;" alt="Hachi Grill" /><p style="color:#198754;margin-top: 5px; ">Order Minuman</p></a>
