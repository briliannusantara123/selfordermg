...
<div class="container text-center">
  <div class="row" style="margin-top: 1px;margin-bottom: 10px;">
    <div class="col">
      <a class="" href="<?= base_url() ?>ordermakanan/menu/Makanan/<?= $sub_category ?>" role="button"  style="text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-makanan.png" style="width: 125px;height: 125px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Order Makanan</p></a>
      ...
      <a class="" href="<?php echo base_url() ?>Review/form/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/suggest.png" style="width: 125px;height: 125px;margin-top: 5px;border-radius: 50%;padding: 5px 5px;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Kritik dan Saran</p></a>
      <a class="" href="<?php echo base_url() ?>Kasir_waitress/meminta/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/discount.png" style="width: 125px;height: 125px;margin-top: 5px;border-radius: 50%;padding: 5px 5px;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Halaman Promo</p></a>
    </div>
