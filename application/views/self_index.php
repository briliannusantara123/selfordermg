...
<div id="loadingkonek"></div>
  ...
  <div class="row">
    ...
    <div class="col-1" style="z-index: 10040000;"><a style="text-align: center;margin-top: 6px;" href="<?php echo base_url() ?>Cart/home/<?= $no_meja ?>/home" class=""><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" color="white" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16" style="margin-right: 10px;margin-top: 12px;margin-left: 10px;">
...
<div class="container text-center">
  <div class="row" style="margin-top: 180px;margin-bottom: 10px;">
    <div class="col">
      <a class="" href="<?= base_url() ?>ordermakanan/menu/Makanan/Chicken#Chicken" role="button"  style="text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-makanan.png" style="width: 125px;height: 125px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Order Food</p></a>
    ...
    <div class="col">
      <a class="" href="<?= base_url() ?>orderminuman/menu/Minuman/<?= $sub_category_minuman ?>#Cold_Drink" role="button"  style="margin-top: 20px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-minuman.png" style="width: 125px;height: 125px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Order Drinks</p></a>
      <a class="" href="<?= base_url() ?>Billsementara/home/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/lihat-bill-sementara.png" style="width: 125px;height: 125px;margin-top: 5px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Bill Preview</p></a>
      ...
      <a class="" href="<?= base_url() ?>promo/home/<?= $no_meja ?>" role="button"  style="margin-top: 25px;text-decoration:none" disabled><img src="<?= base_url();?>/assets/icon/menu/discounts.png" style="width: 125px;height: 125px;margin-top: 5px;border-radius: 50%;padding: 1px 1px;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Promotion</p></a>
    </div>
  </div>
