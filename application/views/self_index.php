...
<div class="container text-center">
  <div class="row" style="margin-top: 180px;margin-bottom: 10px;">
    <div class="col">
      <a class="" href="<?= base_url() ?>ordermakanan/menu/Makanan/Soup#Soup" role="button"  style="text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-makanan.png" style="width: 125px;height: 125px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Order Food</p></a>
    ...
    <div class="col">
      <a class="" href="<?= base_url() ?>orderminuman/menu/Minuman/Smoothies#Smoothies" role="button"  style="margin-top: 20px;text-decoration:none"><img src="<?= base_url();?>/assets/icon/menu/order-minuman.png" style="width: 125px;height: 125px;border-radius: 50%;" alt="Hachi Grill" class="image" /><p style="color:#198754;margin-top: 5px; ">Order Drinks</p></a>
